...
public class Recall {
	...
	static String inputFilePath = "/API Name and Description results (Improved Sorted)\\MRR";
	static String outputFilePath = "/API Name and Description results (Improved Sorted)\\Recall";
	...
	public static void averageRecall(int recallValue) throws IOException{
		...
		FileWriter fwStream = new FileWriter(outputFilePath + "\\Recall\\Recall@" + recallValue + ".txt", true);
        BufferedWriter bwStream = new BufferedWriter(fwStream);
        PrintWriter pwStream = new PrintWriter(bwStream);
