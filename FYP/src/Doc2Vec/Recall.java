...
public class Recall {
	...
	static String inputFilePath = "/API descriptions doc2vec results (sorted)\\MRR";
	static String outputFilePath = "/API descriptions doc2vec results (Improved Sorted)\\Recall";
