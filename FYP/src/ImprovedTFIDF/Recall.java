 ...
 * for modified TF-IDF approach for API description */
...
public class Recall {
	...
	static String inputFilePath = "/API Name and Descriptions results (sorted)\\MRR";
	static String outputFilePath = "/API Name and Descriptions results (sorted)\\Recall";
