 ...
 * for modified TF-IDF approach for API Name */
...
public class FindRanks {
	...
	static String filePath = "/API Name tf-idf results (Improved Sorted)";
    ...
    public static void FindRanks(ArrayList<String> AL, String fileName) throws IOException{
    	...
    	FileWriter fwStream = new FileWriter(filePath + "\\" + fileName.split("\\.csv")[0] + " (FindRanks).txt", true);
