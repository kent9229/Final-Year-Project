 ...
 * for basic TF-IDF approach for API descriptions */
package TFIDF;
...
public class FindRanks {
	...
	static String filePath = "/API descriptions tf-idf results (sorted)";
    ...
    public static void FindRanks(ArrayList<String> AL, String fileName) throws IOException{
    	...
    	FileWriter fwStream = new FileWriter(filePath + "\\" + fileName.split("\\.txt")[0] + " (FindRanks).txt", true);
