 ...
 * for basic TF-IDF approach for API description */
package TFIDF;
...
public class Recall {
	...
	static String inputFilePath = "/API descriptions tf-idf results (sorted)\\MRR";
	static String outputFilePath = "/API descriptions tf-idf results (sorted)\\Recall";
	...
	public static void averageRecall(int recallValue) throws IOException{
		...
		FileWriter fwStream = new FileWriter("C:\\Users\\Kent Ong\\Dropbox\\CSC\\FYP\\Data\\Crawler\\API descriptions tf-idf results (sorted)\\Recall\\Recall@" + recallValue + ".txt", true);
        BufferedWriter bwStream = new BufferedWriter(fwStream);
        PrintWriter pwStream = new PrintWriter(bwStream);
